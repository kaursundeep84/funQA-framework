...
describe('#TC_ConnApp_029 - Connect Application : E2E Dashboard Functionalities', () => {
  ...
  describe('Filtering the projects by the Status', () => {
    ...
    it('Check In review filter function', () => {
      const s = '#wrapper-main .list-nav-container .left-wrapper > li:nth-child(4) > a';
      browser.click(s);
      browser.waitForVisible(`${s}.active`);
      browser.pause(10000);
    ...
    it('Check Reviewed filter function', () => {
      const s = '#wrapper-main .list-nav-container .left-wrapper > li:nth-child(5) > a';
      browser.click(s);
      browser.waitForVisible(`${s}.active`);
      browser.pause(10000);
      browser.elements(projectStatusListDraft).value.should.be.empty;
    ...
    it('Check Completed filter function', () => {
      const s = '#wrapper-main .list-nav-container .left-wrapper > li:nth-child(6) > a';
      browser.click(s);
      browser.waitForVisible(`${s}.active`);
      browser.pause(10000);
      browser.elements(projectStatusListDraft).value.should.be.empty;
    ...
    it('Check Cancelled filter function', () => {
      const s = '#wrapper-main .list-nav-container .left-wrapper > li:nth-child(7) > a';
      browser.click(s);
      browser.waitForVisible(`${s}.active`);
      browser.pause(10000);
      browser.elements(projectStatusListDraft).value.should.be.empty;
    ...
    it('Check Paused filter function', () => {
      const s = '#wrapper-main .list-nav-container .left-wrapper > li:nth-child(8) > a';
      browser.click(s);
      browser.waitForVisible(`${s}.active`);
      browser.pause(10000);
      browser.elements(projectStatusListDraft).value.should.be.empty;
