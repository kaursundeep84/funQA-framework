 ...
 * Test case ID: TC_ConnApp_003
 */

describe('#TC_ConnApp_003 - Connect Application : E2E registration 2', () => {
  ...
  describe('Check registration page', () => {
    ...
    it('Click on the "Register" button', () => {
      ...
      browser.waitForVisible(s, 30000);
      browser.click(s);
      browser.waitForVisible(s2, 30000);
    ...
    it('In the "Verify your email address" page click on "Edit" button to change email', () => {
      ...
      browser.waitForVisible(s3, 30000);
    });
